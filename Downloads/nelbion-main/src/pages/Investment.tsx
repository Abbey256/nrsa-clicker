...
export default function Investment() {
  return (
    <PageLayout
      ...
      subtitle="Join a faith-driven movement transforming Africa through innovation and impact"
    >
      <div className="prose prose-lg max-w-none">
        <section className="mb-16">
          ...
          <p className="text-muted-foreground leading-relaxed mb-4">
            Nelbion Group is seeking seed capital of <strong>$2000</strong> in exchange for 
            <strong> 20% equity</strong> in the parent company. This investment will enable us to:
          </p>
          <ul className="space-y-2 text-muted-foreground mb-6">
            <li>• Complete formal company registration and legal structure</li>
            ...
            <li>• Launch pilot programs in Sierra Leone</li>
            <li>• Build core technology infrastructure (blockchain, AI, cloud)</li>
            <li>• Hire initial management team and technical staff</li>
            <li>• Execute go-to-market strategy and brand awareness campaigns</li>
          </ul>
        </section>
          ...
          <div className="space-y-6">
            <div className="p-6 rounded-lg bg-card border border-border shadow-soft">
              ...
              <p className="text-muted-foreground">
                Complete registration in Nigeria, establish legal entities for subsidiaries, 
                intellectual property protection, and compliance framework.
              </p>
            </div>
