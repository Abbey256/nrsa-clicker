...
export default function Infrastructure() {
  return (
    <PageLayout
      ...
      subtitle="Building Africa's Smart, Sustainable Cities of Tomorrow"
    >
      <div className="space-y-12">
        ...
        <section className="bg-gradient-subtle rounded-lg p-8 border border-border">
          ...
          <p className="text-lg text-muted-foreground leading-relaxed">
            Nelbion Infrastructure is reimagining Africa's urban landscape through intelligent design, sustainable 
            technology, and wireless power. We're building smart cities that combine modern infrastructure with 
            African values, creating livable, efficient, and environmentally conscious urban environments.
          </p>
        </section>
