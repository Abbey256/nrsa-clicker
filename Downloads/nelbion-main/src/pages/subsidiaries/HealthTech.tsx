...
export default function HealthTech() {
  return (
    <PageLayout
      ...
      subtitle="Transforming Healthcare Access Through Technology and Innovation"
    >
      <div className="space-y-12">
        {/* Impact Statement */}
        <section className="bg-gradient-subtle rounded-lg p-8 border border-border">
          <h2 className="text-3xl font-bold text-foreground mb-4">Healthcare for All Africans</h2>
          <p className="text-lg text-muted-foreground leading-relaxed">
            Nelbion HealthTech leverages AI, blockchain, and wireless power to democratize healthcare across Africa. 
            We're building a future where quality medical care is accessible to everyone, regardless of location or 
            economic status, through telemedicine, digital health records, and AI-powered diagnostics.
          </p>
        </section>
        ...
        <section>
          ...
          <div className="grid md:grid-cols-2 gap-6">
            ...
            <SubsidiaryCard
              ...
              description="Secure, portable medical records accessible to authorized providers across Africa, eliminating data silos."
