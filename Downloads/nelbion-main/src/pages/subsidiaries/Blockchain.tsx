...
export default function Blockchain() {
  return (
    <PageLayout
      ...
      subtitle="Building Trust and Transparency Through Decentralized Technology"
    >
      <div className="space-y-12">
        ...
        <section className="bg-gradient-subtle rounded-lg p-8 border border-border">
          ...
          <p className="text-lg text-muted-foreground leading-relaxed">
            Nelbion Blockchain is pioneering the use of distributed ledger technology to solve Africa's most 
            pressing challenges: corruption, lack of transparency, and financial exclusion. Through blockchain 
            innovation and NEL Coin, we're creating a foundation of trust for Africa's digital future.
          </p>
        </section>
        ...
        <section>
          ...
          <div className="grid md:grid-cols-2 gap-6">
            ...
            <SubsidiaryCard
              ...
              description="Native cryptocurrency powering all Nelbion services, enabling fast, low-cost transactions across Africa."
        ...
        <section className="bg-card rounded-lg p-8 border border-border">
          <h2 className="text-3xl font-bold text-foreground mb-6">NEL Coin: Africa's Currency of Trust</h2>
          <div className="space-y-4 text-muted-foreground leading-relaxed">
            <p>
              NEL Coin is the native digital currency of the Nelbion ecosystem, designed specifically for African 
              economic realities. It powers payments across all Nelbion services while providing a stable, secure 
              store of value.
            </p>
