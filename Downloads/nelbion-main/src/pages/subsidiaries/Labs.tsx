...
export default function Labs() {
  return (
    <PageLayout
      title="Nelbion Labs"
      subtitle="The Innovation Engine Powering the Nelbion Ecosystem"
    >
      <div className="space-y-12">
        ...
        <section className="bg-gradient-subtle rounded-lg p-8 border border-border">
          ...
          <p className="text-lg text-muted-foreground leading-relaxed">
            ...
            we turn visionary ideas into working solutions that transform Africa.
          </p>
        </section>
        ...
        <section>
          ...
          <div className="grid md:grid-cols-2 gap-6">
            <SubsidiaryCard
              ...
              description="Building mobile apps, web platforms, and backend systems for all Nelbion subsidiaries with focus on African user needs."
              impact="100+ applications planned"
            />
            <SubsidiaryCard
              icon={Cpu}
              title="Hardware Innovation"
              description="Developing wireless power receivers, IoT sensors, and specialized devices for African infrastructure and agriculture."
