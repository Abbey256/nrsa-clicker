...
export default function FinTech() {
  return (
    <PageLayout
      ...
      subtitle="Democratizing Financial Services Across Africa"
    >
      <div className="space-y-12">
        {/* Impact Statement */}
        <section className="bg-gradient-subtle rounded-lg p-8 border border-border">
          <h2 className="text-3xl font-bold text-foreground mb-4">Banking for Everyone</h2>
          <p className="text-lg text-muted-foreground leading-relaxed">
            Nelbion FinTech is breaking down financial barriers across Africa. Using blockchain technology and 
            mobile-first solutions, we're bringing banking, payments, lending, and financial education to the 
            400 million unbanked Africans, creating economic opportunity for all.
          </p>
        </section>
        ...
        <section>
          ...
          <div className="grid md:grid-cols-2 gap-6">
            ...
            <SubsidiaryCard
              ...
              description="Free digital courses teaching budgeting, saving, investing, and entrepreneurship to Africa's youth."
