...
export default function Security() {
  return (
    <PageLayout
      ...
      subtitle="Protecting Africa's Digital Future Through Advanced Security Solutions"
    >
      <div className="space-y-12">
        {/* Impact Statement */}
        <section className="bg-gradient-subtle rounded-lg p-8 border border-border">
          <h2 className="text-3xl font-bold text-foreground mb-4">Securing Africa's Digital Transformation</h2>
          <p className="text-lg text-muted-foreground leading-relaxed">
            Nelbion Security provides comprehensive cybersecurity and physical security solutions protecting 
            individuals, businesses, and governments across Africa. Using AI, blockchain, and advanced threat 
            detection, we're building a secure foundation for Africa's digital economy.
          </p>
        </section>
              ...
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-muted-foreground">
                    Security operations center monitoring threats across Africa in real-time
                  </p>
                </div>
              </div>
              <div className="flex items-start gap-3">
