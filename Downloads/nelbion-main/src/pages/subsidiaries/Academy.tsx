...
export default function Academy() {
  return (
    <PageLayout
      ...
      subtitle="Empowering Africa's Youth Through Digital Education and Skills Development"
    >
      <div className="space-y-12">
        ...
        <section className="bg-gradient-subtle rounded-lg p-8 border border-border">
          ...
          <p className="text-lg text-muted-foreground leading-relaxed">
            Nelbion Academy is democratizing access to world-class education across Africa. Through our digital 
            learning platform, we provide free and affordable courses in technology, business, agriculture, and 
            essential skills - empowering Africa's youth to compete globally and build sustainable futures.
          </p>
        </section>
        ...
        <section>
          ...
          <div className="grid md:grid-cols-2 gap-6">
            ...
            <SubsidiaryCard
              ...
              description="Business fundamentals, startup development, financial management, and leadership skills for African entrepreneurs."
            ...
            <SubsidiaryCard
              ...
              description="Courses available in major African languages, making quality education accessible to non-English speakers."
