...
export default function Foundation() {
  return (
    <PageLayout
      ...
      subtitle="Empowering Communities Through Sustainable Development and Social Impact"
    >
      <div className="space-y-12">
        ...
        <section className="bg-gradient-subtle rounded-lg p-8 border border-border">
          ...
          <p className="text-lg text-muted-foreground leading-relaxed">
            Nelbion Foundation is the social impact arm of Nelbion Group, dedicated to transforming lives through 
            sustainable development initiatives. We believe that access to electricity, education, clean water, and 
            community empowerment are fundamental rights that drive Africa's progress.
          </p>
        </section>
