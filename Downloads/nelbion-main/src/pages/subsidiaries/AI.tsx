...
export default function AI() {
  return (
    <PageLayout
      title="Nelbion AI"
      subtitle="Building Africa's Most Advanced AI Research and Deployment Platform"
    >
      <div className="space-y-12">
        {/* Impact Statement */}
        <section className="bg-gradient-subtle rounded-lg p-8 border border-border">
          <h2 className="text-3xl font-bold text-foreground mb-4">Africa-Centered Artificial Intelligence</h2>
          <p className="text-lg text-muted-foreground leading-relaxed">
            Nelbion AI is developing artificial intelligence systems specifically designed for African contexts, 
            languages, and challenges. We're building AI that understands African culture, solves African problems, 
            and empowers African innovation across education, business, governance, and healthcare.
          </p>
        </section>
        ...
        <section>
          ...
          <div className="grid md:grid-cols-2 gap-6">
            <SubsidiaryCard
              ...
              description="Natural language processing supporting all major African languages, enabling voice assistants and translation services."
              impact="2,000+ languages supported"
            />
            <SubsidiaryCard
              icon={Brain}
              title="Business Intelligence"
              description="AI-powered analytics, forecasting, and decision support helping African businesses compete globally."
