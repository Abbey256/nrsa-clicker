...
export default function AgriTech() {
  return (
    <PageLayout
      ...
      subtitle="Revolutionizing African Agriculture Through Technology and Innovation"
    >
      <div className="space-y-12">
        {/* Impact Statement */}
        <section className="bg-gradient-subtle rounded-lg p-8 border border-border">
          <h2 className="text-3xl font-bold text-foreground mb-4">Feeding Africa, Empowering Farmers</h2>
          <p className="text-lg text-muted-foreground leading-relaxed">
            Nelbion AgriTech combines artificial intelligence, blockchain technology, and IoT sensors to transform 
            African agriculture. We're solving food security challenges while empowering smallholder farmers with 
            tools to increase yields, access markets, and build sustainable livelihoods.
          </p>
        </section>
